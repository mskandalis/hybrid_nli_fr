...
| **Dataset**       | **Total sentences of the dataset** | **Number of sentences parsed successfully**    |  **Percentage of the sentences parsed successfully <br>(%)**       | **Number of sentences failed to be parsed**     |  
| ------------- | ----------: | -------------: | ----------: |  ----------: | 
