...
| **Dataset**       | **Total sentences of the dataset** | **Number of sentences <br><nobr>parsed successfully</nobr>**    |  **Percentage of the sentences parsed successfully <br>(%)**       | **Number of sentences failed to be parsed**     |  
| ------------- | ----------: | -------------: | ----------: |  ----------: | 
