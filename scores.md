...
| **Dataset**       | **Total sentences of the dataset** | **Number of sentences <br>parsed successfully**    |  **Percentage of the sentences <br>parsed successfully <br>(%)**       | **Number of sentences <br>failed to be parsed**     |  
| ------------- | ----------: | -------------: | ----------: |  ----------: | 
